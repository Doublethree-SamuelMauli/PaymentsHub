  ...
  const plans = [
    {
      ...
      desc: "Ambiente Itaú homologado para validar a integração sem compromisso.",
      features: [
    ...
    },
    {
      ...
      price: "R$ 1.500",
      cadence: "/mês",
      desc: "O sweet spot. Para empresas que rodam pagamento todo dia.",
      features: [
        "Até 1.000 pagamentos/mês",
        "Contas pagadoras ilimitadas",
        "Usuários ilimitados (RBAC completo)",
    ...
    },
    {
      name: "Scale",
      price: "On demand",
      cadence: "sob consulta",
      desc: "Volume alto, multi-banco e SLA contratual. Talhamos pra você.",
      features: [
        "Volume sob medida",
        "Multi-banco (Bradesco, BB, Santander, Itaú)",
        "On-premise ou VPC dedicada",
        "SLA contratual 99,95%",
        "Suporte dedicado · Slack compartilhado",
      ],
